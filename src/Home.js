  ...
  return (
    <div className="cartBackground">
      <div className="welcomeTextHolder">
        ...
        <div>Feel free to navigate around the website and fiddle with the various links provided. I'd love to hear your feedback, especially if you break something!</div>
      </div>
    </div>
  )
}
